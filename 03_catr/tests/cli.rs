...
#[test]
fn e_empty() -> TestResult{
    run(&[EMPTY, "--show-ends"] , "tests/expected/empty-e.out")
}
// --------------------------------------------------

#[test]
fn e_fox() -> TestResult{
    run(&[FOX, "-e"] , "tests/expected/fox-e.out")
}
// --------------------------------------------------

#[test]
fn e_spiders() -> TestResult{
    run(&[SPIDERS, "-e"] , "tests/expected/spiders-e.out")
}
// --------------------------------------------------

#[test]
fn e_bustle() -> TestResult{
    run(&[BUSTLE, "-e"] , "tests/expected/bustle-e.out")
}
// --------------------------------------------------

#[test]
fn all_e_b_empty() -> TestResult{
    run(&[EMPTY, "-e", "-b"], "tests/expected/all_e_empty.out")
}
// --------------------------------------------------

#[test]
fn all_e_n_empty() -> TestResult{
    run(&[EMPTY, "-e", "-n"], "tests/expected/all_e_n_empty.out")
}
// --------------------------------------------------

#[test]
fn all_e_b_fox() -> TestResult{
    run(&[FOX, "-e", "-b"], "tests/expected/all_e_b_fox.out")
}
// --------------------------------------------------

#[test]
fn all_e_n_fox() -> TestResult{
    run(&[FOX, "-e", "-n"], "tests/expected/all_e_n_fox.out")
}
// --------------------------------------------------

#[test]
fn all_e_b_spiders() -> TestResult{
    run(&[SPIDERS, "-e", "-b"], "tests/expected/all_e_b_spiders.out")
}

#[test]
fn all_e_n_spiders() -> TestResult{
    run(&[SPIDERS, "-e", "-n"], "tests/expected/all_e_n_spiders.out")
}

#[test]
fn all_e_all() -> TestResult{
    run(&[EMPTY,SPIDERS,FOX,BUSTLE ,"-e"] ,"tests/expected/all_e_all.out" )
}